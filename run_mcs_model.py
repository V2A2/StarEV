...
def run_mcs_model():
    ...
    input_lb = np.array([[0.16],[0.2]])
    print("input_lb_shape:", input_lb.shape)# (2,1) 2d array
    input_lb = input_lb.reshape(2) #(2,) 1d array
    input_ub = np.array([[0.3],[0.4]])
    input_ub = input_ub.reshape(2)
